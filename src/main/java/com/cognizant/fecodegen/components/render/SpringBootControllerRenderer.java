...
public class SpringBootControllerRenderer extends BaseRenderer {

	private static Logger LOGGER = Logger.getLogger(SpringBootControllerRenderer.class);
	
	public static String PREFIX = "codegen.springBootController"; 
	
	public SpringBootControllerRenderer(Map<String, Object> properties) {
		super(PREFIX, properties);
	}
	
	@Override
	public boolean render(JsonDocument jsonDoc) throws CodeGenException {
		LOGGER.info("SpringBoot Controller Generation... ");
		...
		String className = getProperties().get(Constants.CLASSNAME)+Constants.CONTROLLER;
