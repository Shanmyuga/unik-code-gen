...
public class SpringBootHelperRenderer extends BaseRenderer{

private static Logger LOGGER = Logger.getLogger(SpringBootHelperRenderer.class);
	
	public static String PREFIX = "codegen.springBootHelperRenderer"; 
	
	public SpringBootHelperRenderer(Map<String, Object> properties) {
		super(PREFIX, properties);
	}
	
	@Override
	public boolean render(JsonDocument jsonDoc) throws CodeGenException {
		LOGGER.info("SpringBoot Helper Generation... ");
...
//		LOGGER.info(contextVariables.toString());
		String containerName = getProperties().get(Constants.CLASSNAME)+Constants.HELPER+".java";
