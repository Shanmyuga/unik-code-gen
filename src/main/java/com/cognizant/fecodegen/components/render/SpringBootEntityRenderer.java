...
public class SpringBootEntityRenderer extends BaseRenderer {

	private static Logger LOGGER = Logger.getLogger(SpringBootEntityRenderer.class);
	
	public static String PREFIX = "codegen.springBootEntity"; 
	
	public SpringBootEntityRenderer(Map<String, Object> properties) {
		super(PREFIX, properties);
	}
	
	@Override
	public boolean render(JsonDocument jsonDoc) throws CodeGenException {
		LOGGER.info("Spring Boot Entity Generation... ");
		...
		String containerName = getProperties().get(Constants.CLASSNAME)+Constants.ENTITY+".java";
