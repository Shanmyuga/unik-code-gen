...
public class SpringBootDAOImplRenderer extends BaseRenderer{
	
	private static Logger LOGGER = Logger.getLogger(SpringBootDAOImplRenderer.class);
	
	public static String PREFIX = "codegen.springBootDAOImpl"; 
	
	public SpringBootDAOImplRenderer(Map<String, Object> properties) {
		super(PREFIX, properties);
	}
	
	@Override
	public boolean render(JsonDocument jsonDoc) throws CodeGenException {
		LOGGER.info("SpringBoot DAO Impl Generation... ");
		...
		String className = getProperties().get(Constants.CLASSNAME)+Constants.DAOIMPL;
