...
public class SpringBootExceptionRenderer extends BaseRenderer{

private static Logger LOGGER = Logger.getLogger(SpringBootExceptionRenderer.class);
	
	public static String PREFIX = "codegen.springBootExceptionRenderer"; 
	
	public SpringBootExceptionRenderer(Map<String, Object> properties) {
		super(PREFIX, properties);
	}
	
	@Override
	public boolean render(JsonDocument jsonDoc) throws CodeGenException {
		LOGGER.info("SpringBoot Exception Generation... ");
...
//		LOGGER.info(contextVariables.toString());
		String containerName = getProperties().get(Constants.CLASSNAME)+Constants.EXCEPTION+".java";
