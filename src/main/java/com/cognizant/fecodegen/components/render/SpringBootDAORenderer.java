...
public class SpringBootDAORenderer extends BaseRenderer{

	private static Logger LOGGER = Logger.getLogger(SpringBootDAORenderer.class);
	
	public static String PREFIX = "codegen.springBootDAOImpl"; 
	
	public SpringBootDAORenderer(Map<String, Object> properties) {
		super(PREFIX, properties);
	}
	
	@Override
	public boolean render(JsonDocument jsonDoc) throws CodeGenException {
		LOGGER.info("SpringBoot DAO Generation... ");
		...
		String containerName = getProperties().get(Constants.CLASSNAME)+Constants.DAO+".java";
